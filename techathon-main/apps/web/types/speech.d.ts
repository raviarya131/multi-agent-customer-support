...
// The bundled TS DOM lib here ships the result types but not the recognition
// interface (it's a non-standard, vendor-prefixed API), so we declare what the
// dictation feature in app/page.tsx uses.
